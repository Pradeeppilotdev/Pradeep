...
import VerifyTicker from './VerifyTicker'
...
export default function Hero() {
  ...
  useEffect(() => {
    ...
    gsap.set('.meta-row, .intro-links, .verify-ticker', { opacity: 0, y: 12 })
    ...
    tl
      ...
      .to('.verify-ticker', { opacity: 1, y: 0, duration: 0.5, ease: 'power3.out' }, '-=0.25')
